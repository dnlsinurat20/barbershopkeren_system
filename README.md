...
In a previous Data Audit Project, I analyzed 3 years of historical data from this barbershop. The findings were critical: Revenue stagnation wasn't a business failure; it was a data visibility failure.
...
Frontend: Streamlit (Python) for a responsive, mobile-friendly UI.
...
├── logo_struk.png       # Asset for receipt generation
├── google_apps_script.js # Code used for Drive API middleware
